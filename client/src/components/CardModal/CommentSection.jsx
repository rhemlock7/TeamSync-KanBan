    ...
    return (
        <section className='my-4'>
            ...
            <form onSubmit={handleAddComment}>
                ...
                />
                <div className="">
                    <button className='mr-2' type="submit">Add Comment</button>
                </div>
            </form>

            <div>
                {comments.map(comment => (
                    <div className='bg-gray-200 p-3 my-4 drop-shadow-lg' key={comment._id}>
                        <div className='flex justify-between items-center'>
                            {/* Title and start time */}
                            <div className='flex justify-start items-center'>
                                <Avatar style={{ backgroundColor: '#007EA7' }} size="small">{comment.commentAuthor.charAt(0).toUpperCase()}</Avatar>
